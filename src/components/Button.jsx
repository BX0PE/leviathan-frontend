export default function Button({ children, variant = 'primary', ...props }) {
  const base = 'w-full min-h-tap rounded-card font-display font-semibold text-base tracking-widest uppercase transition active:scale-[0.98] disabled:opacity-40 disabled:active:scale-100'
  const variants = {
